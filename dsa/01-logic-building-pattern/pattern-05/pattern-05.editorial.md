...
2. Inside this loop, run another loop from 0 to (N - current value of the outer loop variable). It will decrease the number of columns as the row value increases.
3. Now, print the asterisk in the inner loop all in one line, to complete the current row.
