...
## Introduction
To begin with computer's is bit overwhelming and challenging if you have not grown up with them. It may looks like everyone else knows exactly what they are doing while we are just starting out.
...
> - Extrmely Fast
> - ZERO brain of it's own.


To give Analogy: **The Obidient Servant**
...
> Computer = Fast + Obedient + No Common Sense
...
> **Flowchart first, code second. Always.**
